    ...
    <div class="page-section">
        <div class="page-wrapper space-y-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <a href="{{ route('admin.buku.create') }}" class="flex items-center p-6 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-sky-500 hover:shadow-md transition-all group">
                    <div class="p-4 bg-sky-50 rounded-lg group-hover:bg-sky-500 group-hover:text-white transition-colors">
                        <svg class="h-6 w-6 text-sky-600 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.5v15m7.5-7.5h-15" />
                        </svg>
                    </div>
                    <div class="ml-5">
                        <h3 class="text-lg font-bold text-slate-900 group-hover:text-sky-600 transition-colors">Tambah Buku</h3>
                        <p class="text-sm text-slate-500">Input koleksi buku baru ke sistem</p>
                    </div>
                </a>

                <a href="{{ route('admin.kategori.create') }}" class="flex items-center p-6 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-amber-500 hover:shadow-md transition-all group">
                    <div class="p-4 bg-amber-50 rounded-lg group-hover:bg-amber-500 group-hover:text-white transition-colors">
                    ...
                    <div class="ml-5">
                        <h3 class="text-lg font-bold text-slate-900 group-hover:text-amber-600 transition-colors">Tambah Kategori</h3>
                        <p class="text-sm text-slate-500">Buat kategori baru untuk pengelompokan</p>
                    </div>
                </a>

                <a href="{{ route('admin.anggota.create') }}" class="flex items-center p-6 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-rose-500 hover:shadow-md transition-all group">
                    <div class="p-4 bg-rose-50 rounded-lg group-hover:bg-rose-500 group-hover:text-white transition-colors">
                    ...
                    <div class="ml-5">
                        <h3 class="text-lg font-bold text-slate-900 group-hover:text-rose-600 transition-colors">Tambah Anggota</h3>
                        <p class="text-sm text-slate-500">Buat akun siswa baru dari dashboard admin</p>
                    </div>
                </a>

                <a href="{{ route('admin.peminjaman.index') }}" class="flex items-center p-6 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-emerald-500 hover:shadow-md transition-all group">
                    <div class="p-4 bg-emerald-50 rounded-lg group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                    ...
                    <div class="ml-5">
                        <h3 class="text-lg font-bold text-slate-900 group-hover:text-emerald-600 transition-colors">Peminjaman</h3>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <div class="metric-card bg-bento-accent">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-widest text-white/80">Total Buku</p>
                            <p class="mt-2 text-3xl font-bold text-white">{{ $totalBuku }}</p>
                        </div>
                        <div class="p-2 bg-white/10 rounded-lg border border-white/10 text-white">
                ...
                <div class="metric-card bg-emerald-600">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-widest text-white/80">Total Stok</p>
                            <p class="mt-2 text-3xl font-bold text-white">{{ $totalStok }}</p>
                        </div>
                        <div class="p-2 bg-white/10 rounded-lg border border-white/10 text-white">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="metric-card bg-rose-600">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-white">{{ $totalUser }}</p>
                        </div>
                        <div class="p-2 bg-white/10 rounded-lg border border-white/10 text-white">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="space-y-4">
                                @forelse($bukuPopuler as $index => $book)
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="shrink-0 inline-flex items-center px-2 py-0.5 rounded-md text-xs font-bold bg-emerald-100 text-emerald-700">
                ...
                <div class="lg:col-span-2">
                    <div class="table-card h-full">
                        <div class="table-toolbar flex justify-between items-center">
                            ...
                            <a href="{{ route('admin.peminjaman.index') }}" class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-bold bg-emerald-100 text-emerald-800 transition hover:bg-emerald-200">
                                Buka Peminjaman
                            </a>
                        </div>
