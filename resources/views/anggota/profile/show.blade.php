<x-anggota-layout>
    <section class="space-y-8 pb-10">
        <!-- Account Header -->
        <div class="flex flex-col items-center text-center space-y-4 md:flex-row md:text-left md:space-y-0 md:space-x-6 bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
            <div class="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-sky-500 to-blue-600 text-3xl font-bold text-white shadow-lg shadow-blue-200">
            ...
            <div class="space-y-1">
                ...
                <div class="flex flex-wrap justify-center md:justify-start gap-2 mt-2">
                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-sky-50 text-sky-700 text-xs font-bold uppercase tracking-wider">Siswa</span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 text-slate-600 text-xs font-bold uppercase tracking-wider">SMKN 40 JAKARTA</span>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <div class="metric-card bg-gradient-to-br from-amber-500 to-orange-500">
        ...
        <div class="pt-4">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-rose-50 text-rose-600 font-bold hover:bg-rose-100 transition duration-200">
